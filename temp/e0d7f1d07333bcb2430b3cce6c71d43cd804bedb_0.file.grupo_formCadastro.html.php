					...
					<div class="box-body">						
			           	<div class="row">
							<div class="form-group col-xs-6">
								<label for="dsc_grupo_descricao">Descrição</label>
								<input name="dsc_grupo_descricao" id="dsc_grupo_descricao" class="form-control required" placeholder="Descrição" type="text" value="<?php echo $_smarty_tpl->tpl_vars['dados']->value['dsc_grupo_descricao'];?>
" maxlength='250'>
							</div>
						</div>
