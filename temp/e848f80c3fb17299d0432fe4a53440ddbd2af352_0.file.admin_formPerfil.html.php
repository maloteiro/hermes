<?php
/* Smarty version 3.1.30, created on 2017-10-17 22:04:39
  from "C:\xampp\htdocs\padrao\base\html\admin\admin_formPerfil.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59e69a97532080_78248805',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e848f80c3fb17299d0432fe4a53440ddbd2af352' => 
    array (
      0 => 'C:\\xampp\\htdocs\\padrao\\base\\html\\admin\\admin_formPerfil.html',
      1 => 1508284931,
      2 => 'file',
    ),
  ),
...
function content_59e69a97532080_78248805 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" />
						<input type="hidden" name="f" id="f" value="salvarPerfil" />
						<input type="hidden" name="token" id="token" value="<?php echo $_SESSION['token'];?>
" />		
						<input type="hidden" name="update" id="update" value="<?php echo $_smarty_tpl->tpl_vars['update']->value;?>
" />
						<input type="hidden" name="seq_perfil" id="seq_perfil" value="<?php echo $_smarty_tpl->tpl_vars['dados']->value['seq_perfil'];?>
" />
					<div class="box-body">						
			           	<div class="row">
							<div class="form-group col-xs-6">
								<label for="dsc_perfil_nome">Descrição</label>
								<input name="dsc_perfil_nome" id="dsc_perfil_nome" class="form-control required" placeholder="Descrição" type="text" value="<?php echo $_smarty_tpl->tpl_vars['dados']->value['dsc_perfil_nome'];?>
" maxlength='250'>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-xs-2">
								<label for="num_rotina_ordem">Sigla</label>
								<input name="sig_perfil_sigla" id="sig_perfil_sigla" class="form-control required" placeholder="Sigla" type="text" value="<?php echo $_smarty_tpl->tpl_vars['dados']->value['sig_perfil_sigla'];?>
" maxlength='4'>
							</div>
						</div>				
						...
						<div class="row">
							<div class="form-group col-xs-2">
								<label for="flg_perfil_ativo">Ativo</label>	<br />							
								<input type="checkbox" class="minimal" name="flg_perfil_ativo" id="flg_perfil_ativo" value="S" <?php if ($_smarty_tpl->tpl_vars['dados']->value['flg_perfil_ativo'] == "S") {?>checked<?php }?>/> <label for="flg_perfil_ativo">Sim</label>
							</div>
						</div>
...
<?php echo '<script'; ?>
 type="text/javascript" src="./public/ajax/adminPerfil.js" charset="iso-8859-1"><?php echo '</script'; ?>
>
